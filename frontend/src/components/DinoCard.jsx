      ...
      <div className="p-7 flex flex-col flex-1">
        ...
        <div className="flex justify-between items-start mb-1">
          ...
          <div className="text-center shrink-0 ml-3">
            <p className="text-[#b0a8a0] text-[9px] uppercase tracking-widest mb-0.5">Dino ID</p>
        ...
        <div className="mt-auto mb-2 shrink-0">
          <span className={`inline-block text-[11px] uppercase tracking-[0.25em] font-black px-4 py-1.5 rounded-lg border ${colorDieta}`}>
            {dino.dieta}
          </span>
        </div>
        ...
        <div className="border-t border-[#3f3833] pt-5">
          <div className="flex justify-between items-center text-center">
            ...
            {/* Longitud */}
            <div className="flex-1">
              <span className="text-[#b0a8a0] text-[9px] uppercase tracking-widest mb-1 block">Longitud</span>
              <span className="text-base font-bold text-white font-mono">{dino.longitud}</span>
            </div>
            
            {/* Altura: border-l solamente para quitar la raya de la derecha */}
            <div className="flex-1 border-l border-[#3f3833] px-2">
              <span className="text-[#b0a8a0] text-[9px] uppercase tracking-widest mb-1 block">Altura</span>
              <span className="text-base font-bold text-white font-mono">{dino.altura}</span>
            </div>
